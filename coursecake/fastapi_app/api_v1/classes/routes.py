...
async def search_courses(
    ...
    class_id: Optional[str] = Query(
        None, title="Class id", description="Unique within the term of a University"
    ),
    ...
    time: Optional[str] = Query(None, title="Time", description="Ex: MWF 8am-9:30am"),
    location: Optional[str] = Query(
        None, title="Location", description="Includes building and room info"
    ),
    building: Optional[str] = Query(
        None, title="Building", description="Unique within university"
    ),
    room: Optional[str] = Query(
        None, title="Room", description="Unique within building"
    ),
    status: Optional[str] = Query(
        None, title="Status", description="OPEN / FULL / CLOSED / etc..."
    ),
