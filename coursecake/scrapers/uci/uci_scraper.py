...
class UciScraper(Scraper):
    ...
    REQUIRED_PARAMS = ["breadth", "instructor", "code", "dept"]
    ...
    def __init__(self, term_id: str = "2020-FALL-1"):
        ...
        self.params = {"YearTerm": self.year_term, "ShowFinals": 1, "ShowComments": 1}
    ...
    def scrapePage(self, page) -> dict:
        ...
        try:
            courseTables = soup.find("div", {"class": "course-list"}).findChildren(
                "table"
            )
    ...
    def getCoursesByCourseCodes(self, max: int = 99999) -> list:
        ...
        while lowerBound < max:
            ...
            courses.update(
                self.merge_courses(self.getCourseCodeCourses(courseCodes), courses)
            )
